...
var timeZone=getElm("timeZone");
if (timeZone.value === "1") {
  errorMsg.push("Time zone is required")
  timeZone.classList.add("errorClass");
} else if (timeZone.classList.remove("errorClass")) {

}

var aboutMe=getElm("aboutMe");
if (aboutMe.value === "") {
  errorMsg.push("About is required")
  aboutMe.classList.add("errorClass");
} else if (aboutMe.classList.remove("errorClass")) {

}


var terms = getElm("TAC");
console.log(TAC.checked);
...
function reset(){
var inputs = ["firstName", "lastName", "Email", "password", "confirmPassword","timeZone","TAC","aboutMe"];
